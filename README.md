...
Given analysis shows the difference between Fandango movie ratings and other movie rating websites.
...
`fandango_scrape.csv` contains every 538 films pulled from Fandango.
